...
df = pd.read_fwf('/Users/stephaniechoo/Desktop/BDPTask3Analysis/Data/K5/K5_Depth8.txt', header=None,delimiter=',')
...
df["Medoid_Longitude"] = df["Medoid_Longitude"].str.strip(',')
...
df['Medoid_Latitude'] = df['Medoid_Latitude'].replace(['0.777496337890625'],'40.777496337890625')
df['Medoid_Longitude'] = df['Medoid_Longitude'].replace(['-73.948974609375,'],'-73.948974609375')
